  ...
  var B,
    ...
    H =
      (c.magnificPopup.registerModule(L, {
        options: {
          markup:
            '<div class="mfp-iframe-scaler"><div class="mfp-close"></div><iframe referrerpolicy=no-referrer class="mfp-iframe" src="//about:blank" frameborder="0" allowfullscreen></iframe></div>',
